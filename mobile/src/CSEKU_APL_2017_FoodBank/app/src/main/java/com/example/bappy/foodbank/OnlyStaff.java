...
public class OnlyStaff extends AppCompatActivity {
                ...
                if(!isNetworkAvilabe())
                    ...
                    Runnable progressrunnable = new Runnable() {
                        ...
                        public void run() {
                            ...
                            startActivity(new Intent(OnlyStaff.this, staff_login_resistor.class));
                            finish();
                        }
                    };
            ...
            case R.id.my_profile:
                if(!isNetworkAvilabe())
                    ...
                    Runnable progressrunnable3 = new Runnable() {
                        ...
                        public void run() {
                            progressDialog.cancel();
                            startActivity(new Intent(OnlyStaff.this, ShowProfile.class));
                        }
                    };
            ...
            case R.id.new_restaurant:
                if(!isNetworkAvilabe())
                    ...
                    Runnable progressrunnable4 = new Runnable() {
                        ...
                        public void run() {
                            progressDialog.cancel();
                            startActivity(new Intent(OnlyStaff.this, CreateNewRestaurant.class));
                        }
                    };
            ...
            case R.id.edit_profile:
                if(!isNetworkAvilabe())
                    ...
                    Runnable progressrunnable5 = new Runnable() {
                        ...
                        public void run() {
                            progressDialog.cancel();
                            Intent intent = new Intent(OnlyStaff.this, EditChangeProfile.class);
    ...
    public void nointernet() {
        ...
        AlertDialog.Builder CheckBuild = new AlertDialog.Builder(OnlyStaff.this);
